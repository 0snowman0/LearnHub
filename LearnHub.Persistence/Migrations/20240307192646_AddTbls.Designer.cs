...
namespace LearnHub.Persistence.Migrations
{
    ...
    [Migration("20240307192646_AddTbls")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LearnHub.Domain.Model.Permistion.Permistion_En", b =>
                {
                    ...
                    b.Property<int?>("AdminProfile_EnId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LearnHub.Domain.Model.Permistion.Permistion_En", b =>
                {
                    b.HasOne("LearnHub.Domain.Model.Prifile.Admin.AdminProfile_En", null)
                        .WithMany("permistion_Ens")
                        .HasForeignKey("AdminProfile_EnId");
                });

            modelBuilder.Entity("LearnHub.Domain.Model.Prifile.Admin.AdminProfile_En", b =>
                {
                    b.Navigation("permistion_Ens");
                });
